            ...
            <div class="bg-light rounded h-100 p-4">
                ...
                <form action="<?= site_url('simpan-satuan'); ?>" method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?= session()->has('errors') ? 'is-invalid' : null; ?>" id="exampleInputEmail1" aria-describedby="emailHelp" name="nama_satuan" placeholder="Masukan Satuan Produk">
