                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form action="<?=site_url('perbarui-kategori');?>" method="POST">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control <?= session()->has('errors') ? 'is-invalid' : null; ?>" id="inputJenis" name="nama_kategori" required new="kategori_produk" value="<?= $detailKategori[0]['nama_kategori'];?>">
